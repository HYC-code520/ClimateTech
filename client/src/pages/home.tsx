    ...
    >
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <footer className="px-4 md:px-6 py-6 flex flex-col sm:flex-row items-center justify-between text-sm space-y-2 sm:space-y-0">
          <div className="flex flex-col sm:flex-row items-center justify-between w-full border border-[var(--botanical-green)]/40 rounded-3xl px-4 py-3 space-y-2 sm:space-y-0">
