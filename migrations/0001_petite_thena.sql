...
ALTER TABLE "funding_rounds" DROP COLUMN "investor_id";--> statement-breakpoint
ALTER TABLE "funding_rounds" ADD CONSTRAINT "funding_rounds_company_id_stage_amount_usd_unique" UNIQUE("company_id","stage","amount_usd");